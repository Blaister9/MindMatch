...
/** Tipos de conexión que la doctora puede autorizar para un paciente. */
export const connectionTypeSchema = z.enum(["amistad", "grupo", "romantica"]);
export type ConnectionType = z.infer<typeof connectionTypeSchema>;

export const CONNECTION_TYPES = connectionTypeSchema.options;

/** Severidad de las alertas del Pulso Emocional. */
export const alertSeveritySchema = z.enum(["baja", "media", "alta"]);
